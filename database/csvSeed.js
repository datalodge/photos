...
let string = "";
let newHead = "homeId,url,thumb_url,is_primary,description\n" 
...
for(let i = 0; i < 10000001; i++){
  ...
  for (let j = 0; j < numPics; j++){
    ...
    string += `${currentId},${s3BucketPath}photos${randomPic}.jpg,${s3BucketPath}thumb_photos${randomPic}.jpg,${is_primary},${getRandomText()}.\n`
